...
class PipelineConfig:
    ...
    # -- a run that times out is still just one 'failed' record, and the
    # rest of the plan (and the pipeline after generate) proceeds. 1
    # (default) is the original sequential loop, byte-for-byte.
    #
